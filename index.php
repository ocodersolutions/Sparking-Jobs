                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form id="fre_credit_updat_bank_form" >
                          <div class="form-group">
                              <label for="benficial_owner">Benficial Owner</label>
                          ...
                          <div class="form-group">
                              <label for="banking_information">Banking Information</label>
                              <textarea id="banking_information" name="banking_information"></textarea>
                          </div>    
                          <div class="form-group">
                              <label for="secure_code">Secure Code</label>
                              <input type="text" class="form-control" id="secure_code" name="secure_code" placeholder="Enter secure code">
                          </div>                       
        ...
        <div class="modal fade email_paypal" id="modalEditPaypal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><i class="fa fa-times"></i></button>
                        <h4 class="modal-title small-modal-title" id="myModalLabel">Update Paypal account information</h4>
                    </div>
                    <div class="modal-body">
                        <form id="fre_credit_edit_paypal_form" >
                          <div class="form-group">
                              <label for="credit_email_paypal">Paypal Account</label>
                              <input type="text" class="form-control" id="email_paypal" name="email_paypal" placeholder="Enter your email paypal">
                          </div>
                          <div class="form-group">
                              <label for="verify_secure_code">Secure Code</label>
                              <input type="text" class="form-control" id="secure_code" name="secure_code" placeholder="Enter secure code">
                          </div>  
                          <button type="submit" class="btn-sumary blue-light box-shadow-button-blue btn-submit">
                              Update                          </button>
        ...
        <div class="modal fade withdraw" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><i class="fa fa-times"></i></button>
                        <h4 class="modal-title small-modal-title" id="myModalLabel">Credit withdraw</h4>
                    </div>
                    <div class="modal-body">
                        <form id="fre_credit_withdraw_form" >
                            <div class="balance-withdraw">
                                <div class="current">
                                    ...
                                    <span class="price text-blue-light fre_credit_total">$0200</span>
                                </div>
                                <div class="available">
                                    <span>Available credit</span>
                                    <span class="price text-green-dark fre_credit_available">$0200</span>
                                </div>
                                <div class="frozen">
                                    <span>Frozen credit</span>
                                    <span class="price fre_credit_freezable">$0200</span>
                                </div>
                            </div>
                            <div class="amount-withdraw">
                                <p class="title">Withdraw amount </p>
                                <p class="price-amount">Minimum amount is <span class="fre_credit_min_withdraw"></span></p>
                            ...
                            <div class="amount-withdraw security-code">
                                <p class="title">Security code</p>
                                <p class="price-amount">Please enter the code that we provided you when register.</p>
                                <div class="input-amount">
                                    <input type="password" name="secureCode" value="">
                                </div>
                            </div>
                            <button type="submit" class="btn-sumary blue-light box-shadow-button-blue btn-submit">Submit</button>
                        </form>
                    </div>
                </div>
            </div>
                        ...
                        <div>
                            <form role="form" id="private_msg_form" class="form-horizontal validateNumVal" novalidate="novalidate">
                                <div class="form-group">
                                    ...
                                    <label for="inputEmailTo" class="col-md-2 col-xs-2 control-label">To: </label>
                                    <div class="col-md-10 col-xs-10">
                                        ...
                                        <div class="info-profile-freelancer-bidding">
                                            <span class="name-profile">user name</span><br>
                                            <span class="position-profile">Job title</span>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="inputSubject" class="col-md-2 col-xs-12 control-label">Subject</label>
                                    <div class="col-md-10 col-xs-12">
                                        <input id="inputSubject" name="post_title" type="text" placeholder="Branding" class="form-control width100p" value="no subject" required >
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <div class="col-md-offset-2 col-md-10">
                                        <button type="submit" class="btn btn-primary btn-send-msg-modal">Send Message</button>
                                    </div>
                                </div>
                ...
                <div class="content-conversation ">
                    <a href="#" class="ae-private-message-conversation-wrapper action" data-action="show">
                        ...
                        <span class="title-conversation">
                            <strong>{{= post_title }}</strong> in                            <span class="text-underline">{{= project_name }}</span>
                        </span>
                    ...
                    <button type="button" class="btn btn-delete-conversation  action archive" data-action="archive" title=""  data-toggle="tooltip" data-placement="top" data-original-title="Archive conversation">
                        <span><i class="fa fa-trash"> </i>  Archive</span>
                    </button>
    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <div id="header_bot">
          <div class="container">
            <div class="row">
              <div class="col-sm-12 header_bot_one">
                <div class="row">
                  <div class="col-sm-6 header_bot_one_left">
                    <form action="">
                      <input type="text" name="search_header" placeholder="Find Services">
                      <button type="submit"><i class="fa fa-search" aria-hidden="true"></i></button>
                    </form>
                  </div>
                  <div class="col-sm-5 col-sm-offset-1 header_bot_one_right">
                    <ul>
                      <li>Community</li>
                      <li>
              ...
              <div class="col-sm-12 header_bot_two">
                <div class="row header_menu">
                  <div class="col-sm-2 header_menu_op header_menu_op_website">
                    <div>
                      <i class="fa fa-users" aria-hidden="true"></i>
                      <span>Websites, IT & Software</span>
                    </div>
                  </div>
                  <div class="col-sm-2 header_menu_op header_menu_op_mobile">
                    <div>
                      <i class="fa fa-users" aria-hidden="true"></i>
                      <span>category list-2</span>
                    </div>
                  </div>
                  <div class="col-sm-2 header_menu_op header_menu_op_design">
                    <div>
                      <i class="fa fa-users" aria-hidden="true"></i>
                      <span>category list-3</span>
                    </div>
                  </div>
                  <div class="col-sm-2 header_menu_op header_menu_op_writing">
                    <div>
                      <i class="fa fa-users" aria-hidden="true"></i>
                      <span>category list-4</span>
                    </div>
                  </div>
                  <div class="col-sm-2 header_menu_op header_menu_op_data">
                    <div>
                      <i class="fa fa-users" aria-hidden="true"></i>
                      <span>category list-5</span>
                    </div>
                  </div>
                  <div class="col-sm-2 header_menu_op header_menu_op_local">
                    <div>
                      <i class="fa fa-users" aria-hidden="true"></i>
                      <span>category list-6</span>
                    </div>
                  </div>
                  <div class="col-sm-2 header_menu_op header_menu_op_sales">
                    <div>
                      <i class="fa fa-users" aria-hidden="true"></i>
                      <span>category list-7</span>
                    </div>
                  </div>
                  <div class="col-sm-2 header_menu_op header_menu_op_translation">
                    <div>
                      <i class="fa fa-users" aria-hidden="true"></i>
                      <span>category list-8</span>
                    </div>
                  </div>
                  <div class="col-sm-2 header_menu_op header_menu_op_product">
                    <div>
                      <i class="fa fa-users" aria-hidden="true"></i>
                      <span>category list-9</span>
                    </div>
                  </div>
                  <div class="col-sm-2 header_menu_op header_menu_op_engineering">
                    <div>
                      <i class="fa fa-users" aria-hidden="true"></i>
                      <span>category list-10</span>
                    </div>
                  </div>
                  <div class="col-sm-2 header_menu_op header_menu_op_business">
                    <div>
                      <i class="fa fa-users" aria-hidden="true"></i>
                      <span>category list-11</span>
                    </div>
                  </div>
                  <div class="col-sm-2 header_menu_op header_menu_op_other">
                    <div>
                      <i class="fa fa-users" aria-hidden="true"></i>
                      <span>category list-12</span>
                    </div>
                  </div>
                </div>
              </div>
    ...
    <div class="container-fluid">
      <div class="row">
        <div id="body_content_top">
          <div class="container">
            <div class="row">
              <div class="col-sm-3 body_sidebar">
                <div class="body_sidebar_main">
                  <div class="body_sidebar_one">
                    <h2>Lorem ipsum</h2>
                    <p>Request the service you are looking for.</p>
                    <span>Lorem ipsum</span>
                  </div>
                  <div class="body_sidebar_two">
                    <h3>BUY IT AGAIN</h3>
                    <img src="assets/images/buy_it_again.jpg" alt="">
                    <div>
                      <p>design</p>
                      <p>PROFESIONAL</p>
                      <p>business card</p>
                      <p class="sibar_two_p_color">C$13.38 WITH</p>
                      <p class="sibar_two_p_color">EXTRAS</p>
                    </div>
                  </div>
              ...
              <div class="col-sm-9 body_main_content">
                <div class="body_content_slider">
                  <div id="myCarousel" class="carousel slide" data-ride="carousel">
                    ...
                    <div class="carousel-inner" role="listbox">
                      <div class="item active">
                        <img src="assets/images/slider.jpg" alt="Chania">
                      </div>
                      <div class="item">
                        <img src="assets/images/slider.jpg" alt="Chania">
                      </div>
                ...
                <div class="row body_content_product">
        ...
        <div id="footer_public">
          <div class="container">
            <div class="row">
              ...
              <div class="col-sm-6 body_content_bot_right">
                <p>0</p>
        ...
        <div id="footer_content">
          <div class="container">
            <div class="row footer_content_top">
              ...
              <div class="col-sm-4 footer_app_store">
                <img src="assets/images/footer_image_1.png" alt="">
                <img src="assets/images/footer_image_2.png" alt="">
                <p>Download the SparkingJobs App</p>
                <p>Connect with talented freelancers & manage your project wherever you are on the go.</p>
              </div>
              <div class="col-sm-12"><div class="footer_line"></div></div>
              <div class="col-sm-7">
                ...
                <div class="copyright_bot">
                  <p>Sparkingjobs <i class="fa fa-registered" aria-hidden="true"></i> is a registered Trademark of sparking jobs Technology Pty Limited</p>
                  <p>Sparkingjobs <i class="fa fa-copyright" aria-hidden="true"></i> 2016 sparkingjobs Technology Pty Limited ACN 123456</p>
                </div>
              </div>
              <div class="col-sm-5 footer_link">
