...
jQuery(document).ready(function($) {
	...
	// Animation hover menu "Themes"
	$('.main-menu ul li.sub-menu, .main-menu ul li.resource').hover(function() {
		setTimeout(function(){
			$('.sub-main-nav').addClass('sub-width');
			$('#header_menu').fadeOut('slow');
		}, 500);
	});
	$('.sub-main-nav').mouseleave(function(event) {
		setTimeout(function(){
			$('.sub-main-nav').removeClass('sub-width');
			$('#header_menu').fadeIn('slow');
		}, 500);
	});
	$(".sub-main-nav .main-menu ul li.resource, .main-menu ul li.resource").mouseover(function(event) {
		$(".list-themes").addClass('collapse');
		$(".list-resources").removeClass('collapse');
	});
	$(".sub-main-nav .main-menu ul li.sub-menu, .main-menu ul li.sub-menu").mouseover(function(event) {
		$(".list-themes").removeClass('collapse');
		$(".list-resources").addClass('collapse');
	});
